  ...
  <div class="card rounded keepcard">
    ...
    <div class="card-img-overlay selectable">
      <div class="text-end textbot d-flex justify-content-between">
        <h5 class="text-light card-text">{{ keep.name }}</h5>
        <router-link
          ...
          <div class="row pe-5 me-1">
            ...
            <div class="col-md-3 pe-5">
              <div
                ...
                "
              >
                <h2 class="card-title text-dark">{{ keep.name }}</h2>
                <p class="card-text">
              ...
              <h5 class="card-text pt-3 text-dark">
                <small> <b class="text-dark"> Description: </b> </small> <br />
                {{ keep.description }}
              </h5>
              <div class="modaltext d-flex">
                ...
                <h5>
                  <img
                    :src="keep.creator.picture"
                    class="rounded-circle profilepic ms-5"
                    alt=""
                  />
                  {{ keep.creator.name }}
                </h5>
